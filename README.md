...
![coverage](https://img.shields.io/badge/coverage-52.85%25-blue)
![ci](https://img.shields.io/badge/CI-GitHub%20Actions-9cf)

> _Status auto-generated from the Vitest run: **53/53 tests passing** across **8 file(s)**, **52.85%** line coverage. This block is updated by CI — do not edit by hand._
